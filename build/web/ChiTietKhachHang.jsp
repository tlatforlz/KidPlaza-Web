                                        ...
                                        <div class="fieldset"> 
                                            ...
                                            <ul class="form-list">
                                                ...
                                                <li> <label for="email" class="required"><em>*</em>Địa chỉ email</label>
                                                    <div class="input-box"> <input readonly type="text" name="email" id="email" value="<%=kh.getEmail()%>" title="Địa chỉ email" class="input-text required-entry validate-email"></div>
                                                </li>
