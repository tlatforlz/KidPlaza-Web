<%-- 
    Document   : DanhSachTaiKhoanHeThong
    Created on : May 13, 2017, 2:34:21 AM
    Author     : tranl
--%>
                ...
                <div class="graphs">
                    ...
                    <div class="xs">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <%                                    int count = 1;
                                    for (NHANVIEN bl : list) {
                                        
                                %>
                                <tr>    

                                    <td name="STT"> <%=count%></td>
                                    <td><%=bl.getTaiKhoan()%></td>
                                    <td><%=bl.getMatKhau()%></td>
                                    <td><%=bl.getTb_loainhanvien_MaLoaiNhanVien()%></td>
                                    <td>
                                        <button type="button" class="btn btn-primary"><a style="color:black" href="SuaQuyenNhanVien?TaiKhoan=<%=bl.getTaiKhoan()%>">Sửa quyền</a></button>
                                        <button type="button" class="btn btn-warning"><a style="color:black" href="XoaNhanVien?TaiKhoan=<%=bl.getTaiKhoan()%>">Xóa</a></button>
                                    </td>                                    
                                </tr>
                                <%count++;
                                    }%>
