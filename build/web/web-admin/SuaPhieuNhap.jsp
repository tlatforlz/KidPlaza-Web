<%-- 
    Document   : SuaPhieuNhap
    Created on : May 1, 2017, 10:11:52 AM
    Author     : tranl
--%>

<%@page import="DAO.NHANVIEN_DAO"%>
<%@page import="DTO.CHITIETPHIEUNHAP"%>
            ...
            <div id="page-wrapper" style="background-color: white">
                <div class="graphs">
                    ...
                    <div class="xs">
                        ...
                        <hr>
                        <%
                            PHIEUNHAP ph = (PHIEUNHAP) request.getAttribute("PhieuNhap");
                ...
                $("#luulai").on('click', function () {
                    $("#formLuu").submit();
                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" id="formLuu" action="LuuPhieuNhapSua?MaPhieuNhap=<%=ph.getMaPhieuNhap()%>">

                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Mã Phiếu Nhập</label>
                                    <div class="col-sm-8">
                                        <h4 style="margin-top:10px"><%=ph.getMaPhieuNhap()%></h4>
                                        <input style="display:none" name="MaPhieuNhap" value="<%=ph.getMaPhieuNhap()%>"/>
                                    </div>
                                </div>
                                        ...
                                        <select name="sp_nhacungcap" class="form-control1">
                                            <%
                                                ...
                                                for (NHACUNGCAP ncc : list) {
                                                    if (ncc.getMaNhaCungCap().equals(ph.getTb_nhacungcap_MaNhaCungCap())) {
                                            %>

                                            <option selected value="<%=ncc.getMaNhaCungCap()%>"> <%=ncc.getTenNhaCungCap()%></option>
                                            <%} else {%>
                                ...
                                <hr>
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary"><a style="color:black" href="ThemChiTietPhieuNhapSua?yc=sanphammoi&MaPhieuNhap=<%=ph.getMaPhieuNhap()%>">Thêm Mới</a></button>
                                    <button type="button" class="btn btn-warning"><a style="color:black" href="ThemChiTietPhieuNhapSua?yc=sanphamsan&MaPhieuNhap=<%=ph.getMaPhieuNhap()%>">Thêm vào sản phẩm có sẵn</a></button>
                                </div>
                                <div class="xs">         
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                ...
                                                ArrayList<SANPHAM> list_mau = sp_dp.getListSP_temp(ph.getMaPhieuNhap());
                                            ...
                                            <tr>    
                                                ...
                                                <td>                                              
                                                    <button type="button" class="btn btn-primary"><a style="color:black" href="ChinhSuaSanPhamPhieuNhap?MaSanPham=<%=sp.getMaSanPham()%>&MaPhieuNhap=<%=ph.getMaPhieuNhap()%>">Sửa</a></button>
                                                    <button type="button" class="btn btn-warning"><a style="color:black" href="XoaSanPhamPhieuNhap?MaSanPham=<%=sp.getMaSanPham()%>&MaPhieuNhap=<%=ph.getMaPhieuNhap()%>">Xóa</a></button>
                                                </td>                                    
                                            </tr>
                                            <% count++;
                                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-warning"><a style="color:black" href="HuySuaPhieuNhap?MaPhieuNhap=<%=ph.getMaPhieuNhap()%>">Hủy</a></button>
                                </div>
