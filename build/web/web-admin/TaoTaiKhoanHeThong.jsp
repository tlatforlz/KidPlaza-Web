<%-- 
    Document   : TaoTaiKhoanHeThong
    Created on : May 10, 2017, 7:30:26 PM
    Author     : tranl
--%>
...
<html>
    <head>
        <title>Thêm Tài khoản hệ thống</title>
...
//                                result_error.appendTo("#error-tk");
                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <form id="form-sanpham" class="form-horizontal" action="ThemTaiKhoanHeThong" method="GET">
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Tên tài khoản</label>
                                    <div id="error-tk" class="col-sm-8">
                                        <input name="sp_name" type="text" class="form-control1" id="sp_name" placeholder="Tên tài khoản">       
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="sp_password" type="text" class="form-control1" id="sp_password" placeholder="Mật khẩu">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <button id="btn-add" type="submit" class="btn-success btn"> Thêm </button>
