                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <%
                                        String DiaChi = "";
                                        if(bl.getDiaChi() == null || bl.getDiaChi().equals("")){
                                            DiaChi += "Chưa có thông tin";
                                        }else{
                                            DiaChi += bl.getDiaChi();
                                        }
                                        if(bl.getTinh() == null || bl.getTinh().equals("")){
                                            DiaChi += "- Chưa có thông tin";
                                        }else{
                                            DiaChi += "- " + bl.getTinh();
                                        }
                                        if(bl.getQuocGia() == null || bl.getQuocGia().equals("")){
                                            DiaChi += "- Chưa có thông tin";
                                        }else{
                                            DiaChi += "- " + bl.getQuocGia();
                                        }
                                    %>
                                    <td name="DiaChi"><%=DiaChi%></td>
