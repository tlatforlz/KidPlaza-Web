 ...
 * @author tranl
 */
public class ThemMoiNhaCungCap extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ThemMoiNhaCungCap.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
