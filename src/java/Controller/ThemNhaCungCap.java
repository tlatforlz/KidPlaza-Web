 ...
 * @author tranl
 */
public class ThemNhaCungCap extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean checkNCC = ncc_dp.checkTenNCC(NhaCungCap);
        if (checkNCC == true) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ThemNhaCungCap.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
