 ...
 * @author tranl
 */
public class ChiTietDuyetDonDatHang extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("web-admin/DuyetDonDatHang.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ChiTietDuyetDonDatHang.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
