                                                            ...
                                                            <div id="top_login" class="top-login pull-left">
                                                                ...
                                                                <div class="toplogin" id="topLogin">
                                                                    <div class="right-login hidden-sm hidden-xs">
                                                                        <p class="p-account-link">
                                                                            <a href="" class="account-icon-link"> <span class="ico-user"><span></span></span> <span class="link-box"> Xin chào<strong> <span id="account_link_id">Tài khoản</span> <span class="caret"></span> </strong>
                                                                                </span>
                                                                            </a>
                                                                        </p>
                                                                    </div>
                                                                ...
                                                                <div id="login_content">
                                                                    <div id="customer_menu_links">
                                                                        <ul>
                                                                            <li> <i class="glyphicon glyphicon-user"></i> <a href="">Tài khoản của tôi</a></li>                            
                                                                            <li> <i class="glyphicon glyphicon-log-out"></i> <a href="">Đăng xuất</a></li>
                                                                        </ul>
                                                                    </div>
