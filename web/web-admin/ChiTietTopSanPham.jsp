<%-- 
    Document   : ChiTietTopSanPham
    Created on : May 10, 2017, 12:28:58 AM
    Author     : tranl
--%>
                ...
                <div class="graphs">
                    <div class="xs">
                        <%
                            ...
                            String TongLoiNhuan = SANPHAM.convertToVND(ddh_dp.TongLoiNhuan());
                        %>
                        <h3>Tổng doanh thu : <%=TongLoiNhuan%> VNĐ</h3>
                        <h3>Danh sách sản phẩm lợi nhuận</h3>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td><%=SANPHAM.convertToVND(sp.getDonGia())%></td>
