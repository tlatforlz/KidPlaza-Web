<%-- 
    Document   : DanhSachDonDatHangThanhCong
    Created on : May 10, 2017, 1:26:13 AM
    Author     : tranl
--%>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td><%=dh.getNgayDat()%></td>
                                    <%
                                        int TinhTrang = dh.getDaThanhToan();
                                        String status = "";
                                        if (TinhTrang == 1) {
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary"><a style="color:black" href="ChiTietDonDatHang?MaDonDatHang=<%=dh.getMaDonDatHang()%>">Xem</a></button>
                                    </td>                                    
                                </tr>
                                <%count++;
                                    }%>
