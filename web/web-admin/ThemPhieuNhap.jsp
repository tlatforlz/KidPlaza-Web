                ...
                <div class="graphs">
                    ...
                    <div class="xs">
                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" id="formLuu" action="LuuPhieuNhap">
                                <%
            ...
            $(document).ready(function () {
                $("#luulai").on('click', function () {
                    $("#formLuu").submit();
                                ...
                                <hr>
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary"><a style="color:black" href="ThemChiTietPhieuNhap?yc=sanphammoi">Thêm Mới</a></button>
                                    <button type="button" class="btn btn-warning"><a style="color:black" href="ThemChiTietPhieuNhap?yc=sanphamsan">Thêm vào sản phẩm có sẵn</a></button>
                                </div>
                                <%
                                    SANPHAM_DAO sp_dp = new SANPHAM_DAO();
                                    ArrayList<SANPHAM> list_mau = sp_dp.getListSP_temp();
                                    if (list_mau.isEmpty()) {
                                %>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>    
                                            ...
                                            <td>                                              
                                                <button type="button" class="btn btn-primary"><a style="color:black" href="ChinhSuaSanPhamPhieuNhap?MaSanPham=<%=sp.getMaSanPham()%>">Sửa</a></button>
                                                <button type="button" class="btn btn-warning"><a style="color:black" href="XoaSanPhamPhieuNhap?MaSanPham=<%=sp.getMaSanPham()%>">Xóa</a></button>
                                            </td>                                    
                                        </tr>
                                        <% count++;
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-warning"><a style="color:black" href="HuyPhieuNhap">Xóa</a></button>
                                </div>
                                <%}%>
                            </form>
                        </div>
