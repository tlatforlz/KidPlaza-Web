...
<body>
    ...
    <div id="wrapper">
        ...
        <style>
            #sp_name-error, #sp_mota-error, #sp_soluong-error, #sp_giatien-error{
                color:red;
            }
        </style>
            ...
            <div class="graphs">
                <div class="xs">
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                        <form id="form-sanpham" class="form-horizontal" action="SanPham?yc=them" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8"><textarea name="sp_mota" id="sp_mota" cols="50" rows="4" class="form-control1"></textarea></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="sp_giatien" type="number" class="form-control1" id="sp_giatien" value="0">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="link-image" id="link-image" value="">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
