<%-- 
    Document   : SuaNhaCungCap
    Created on : May 9, 2017, 1:00:53 AM
    Author     : tranl
--%>
                ...
                <div class="graphs">
                    <div class="xs">
                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <%
                                NHACUNGCAP ncc = (NHACUNGCAP) request.getAttribute("NhaCungCap");
                            %>
                            <form id="form-nhacungcap" class="form-horizontal" action="SuaChiTietNhaCungCap?MaNhaCungCap=<%=ncc.getMaNhaCungCap()%>" method="POST">

                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Tên nhà cung cấp</label>
                                    <div class="col-sm-8">
                                        <input name="sp_name" type="text" class="form-control1" id="sp_name"  value="<%=ncc.getTenNhaCungCap()%>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="sp_address" type="text" class="form-control1" id="sp_address" value="<%=ncc.getDiaChi()%>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="sp_email" type="text" class="form-control1" id="sp_email" value="<%=ncc.getEmail()%>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="sp_phone" type="text" class="form-control1" id="sp_phone" value="<%=ncc.getSoDienThoai()%>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="sp_fax" type="text" class="form-control1" id="sp_fax" value="<%=ncc.getFax()%>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <button id="add-themnhacungcap" type="button" class="btn btn-primary "> <p style="color:black"> Sửa </p> </button>
